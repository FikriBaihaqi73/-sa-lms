...
export class ActivityLogService {
  ...
  async create(dto: CreateActivityLogDto) {
    ...
    const input: CreateActivityLogInput = {
      ...
      module: dto.module,
      action: dto.action,
      ...(dto.table_name !== undefined && { table_name: dto.table_name ?? undefined }),
      ...(dto.record_id !== undefined && { record_id: dto.record_id ?? undefined }),
      ...(dto.ip_address !== undefined && { ip_address: dto.ip_address ?? undefined }),
      ...(dto.user_agent !== undefined && { user_agent: dto.user_agent ?? undefined }),
    };
